...
<div class="wrapper" id="container">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr v-for='(value,index) in info.list'>
                                ...
                                <td>
                                    ...
                                    <a href='#' class='delete btn btn-xs btn-danger' @click="associatedUser(value.id)">关联用户</a>
                                    <a href='#' class='edit btn btn-xs btn-primary' @click="associatedPrivilege(value.id)">角色授权</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" id="roleInfo">
    ...
    <!-- 模态框（Modal）-->
    <div class="modal fade" id="Privilege" tabindex="-1" role="dialog" aria-labelledby="myPrivilege" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    ...
                    <h4 class="modal-title" id="myPrivilege">
                        授权
                    </h4>
                </div>
                <div class="modal-body">
                    <ul id="tree" class="ztree"></ul>
                    <button type="button" id="authorization" class="btn btn-default" @click="authorization()">授权</button>
                </div>
            </div>
        </div>
    </div>
