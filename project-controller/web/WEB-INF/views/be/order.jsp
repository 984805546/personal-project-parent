                    ...
                    <div class="col-md-12 column">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr v-for='(value,index) in info.list'>
                                ...
                                <td v-else>未支付</td>
                                <td>
                                    <a href='#' class='delete btn btn-danger' @click="deleteRow(value.orderId)">删除</a>
                                    <a v-if="value.orderStatus === 2" href='#' class='ship btn btn-info' @click="ship(value.orderId)">发货</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
