...
<html class="no-js" lang="">
    <head>
        ...
        <script src="/static/customer/js/product-details.js"></script>
    </head>
    <body>
    <div id="HomeBody" data="${productId}">
        <!--[if lt IE 8]>
                        ...
                        <div class="product-img-tab clearfix">
                           <div class="product-main-img tab-content div-insert-active">
                               ...
                               <div id="one" role="tabpanel"  class="p-tab-img">
                                   <a href="#"><img id="zoom_01" src="/static/customer/img/shop/big1.jpg" data-zoom-image="/static/customer/img/shop/big1.jpg" alt=""></a>
                               </div>
                               <div id="two" role="tabpanel"  class="p-tab-img">
                                   <a href="#"><img id="zoom_02"  src="/static/customer/img/shop/big2.jpg" data-zoom-image="/static/customer/img/shop/big2.jpg" alt=""></a>
                               </div>
                               <div id="three" role="tabpanel"  class="p-tab-img">
                                   <a href="#"><img id="zoom_03"  src="/static/customer/img/shop/big3.jpg" data-zoom-image="/static/customer/img/shop/big3.jpg"  alt=""></a>
                               </div>
                               <div id="four" role="tabpanel"  class="p-tab-img">
                                   <a href="#"><img id="zoom_04"  src="/static/customer/img/shop/big4.jpg" data-zoom-image="/static/customer/img/shop/big4.jpg"  alt=""></a>
                               </div>
                           </div>
                           <div class="product-img-list li-insert-active">
                               <ul role="tablist">
                                   ...
                                   <li role="presentation"><a href="#one" aria-controls="one" role="tab" data-toggle="tab"><img src="/static/customer/img/shop/big1.jpg" alt=""></a></li>
                                   <li role="presentation"><a href="#two" aria-controls="two" role="tab" data-toggle="tab"><img src="/static/customer/img/shop/big2.jpg" alt=""></a></li>
                                   <li role="presentation"><a href="#three" aria-controls="three" role="tab" data-toggle="tab"><img src="/static/customer/img/shop/big3.jpg" alt=""></a></li>
                                   <li class="hidden-xs" role="presentation"><a href="#four" aria-controls="four" role="tab" data-toggle="tab"><img src="/static/customer/img/shop/big4.jpg" alt=""></a></li>
                               </ul>
                           </div>
                        </div>
                    </div>
...
<%--			$(function(){--%>
<%--				$(".div-insert-active").find("div:eq(0)").attr("class","p-tab-img active");--%>

<%--				$(".li-insert-active").find("ul>li:eq(0)").attr("class","active");--%>
<%--				$(".li-insert-active").find("ul>li:last").attr("class","hidden-xs");--%>
<%--			})--%>
<%--		</script>--%>
    </body>
</html>
